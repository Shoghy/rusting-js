...
describe("should convert string into utf-8", () => {
  test("ASCII characters", () => {
    ...
    expect(utf8Arr).toEqual(new Uint8Array([72, 101, 108, 108, 111]));
  });
  ...
  test("Japanese texts", () => {
    ...
    expect(arr2).toEqual(
      new Uint8Array([
        227, 129, 138, 229, 133, 131, 230, 176, 151, 227, 129, 167, 227, 129,
        153, 227, 129, 139,
      ]),
    );
  });
  ...
  test("ñ", () => {
    ...
    expect(utf8Arr).toEqual(new Uint8Array([195, 177]));
  });
...
`);
  ...
  test("AMONG US", () => {
    ...
    expect(arr).toEqual(new Uint8Array([224, 182, 158]));
  });
});
